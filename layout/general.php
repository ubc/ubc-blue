...
if (!empty($PAGE->theme->settings->customlogourl)) {
	...
	$logourl_rms = $OUTPUT->pix_url('logo_rms', 'theme');
}
...
<!-- begin of page-header -->
                            ...
                            <div id="page-header">
                                ...
                                <?php if ($displaylogo) { ?>
                                    <div id="headerlogo">
                                        <img align="left" src="<?php echo $logourl ?>" alt="Custom logo here" />
                                    </div>
									<div id="headerlogo2">
										<img align="right" src="<?php echo $logourl_rms ?>" alt="Custom logo here" />
                                    </div>
                                <?php } else { ?>
...
<!-- Begin Help division -->
<div style="background-color:#F5F6F8; height: 12px;" id="custommenu"><p align="right">Need help? <a href='mailto:rms.training@ubc.ca'>Contact the site administrator</a></p></div>
<!-- End Help division -->
        ...
        <div id="page-footer" class="noframefooter">
            ...
            <div class="moodledocsleft">
               ...
               // if ($PAGE->theme->settings->creditstomoodleorg == 2) {
                ...
                <?php
               // }
				echo "Need help? <a href='mailto:rms.training@ubc.ca'>Contact the site administrator</a>";
