...
/**
 * Strings for component 'theme_ubc_blue', language 'en', branch 'MOODLE_20_STABLE'
 *
...
<div class="clearfix">
    <div class="theme_screenshot">
        <h2>UBC Blue</h2>
        <img src="ubc_blue/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>UBC Blue is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
...
$string['configtitle'] = 'UBC Blue theme';
...
$string['noframe'] = 'UBC Blue 1.9 look';
